...
overland.Geom.domain.Patches = "bottom slope1 channel slope2 side"
...
# overland.Solver.OverlandKinematic.SeepageOne = 3
...
make_solid_file(nx=gridnx, ny=gridny,
                bottom_val=1, side_val=5, top_val1=2, top_val2=3, top_val3=4, reservoir_value=3,
